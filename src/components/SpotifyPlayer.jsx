...
export default function SpotifyPlayer() {
  ...
  return (
    <div className="fixed bottom-6 right-6 md:static animate-fade-in w-full max-w-[20rem] md:max-w-md lg:max-w-lg md:mx-auto">
      ...
      <div className="bg-white/40 dark:bg-black/40 backdrop-blur-2xl border border-black/5 dark:border-white/5 rounded-[2rem] overflow-hidden shadow-2xl flex flex-col transition-all duration-700 hover:border-black/10 dark:hover:border-white/10 group">
        
        {/* Cabecera Sutil de Spotify */}
        <div className="flex items-center justify-between px-6 py-4 bg-black/[0.03] dark:bg-white/[0.03] border-b border-black/5 dark:border-white/5 transition-colors duration-700">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] uppercase tracking-[0.3em] font-light text-black/40 dark:text-white/40">Spotify Session</span>
          </div>
        ...
        {/* Pie sutil */}
        <div className="px-6 py-2 bg-black/5 dark:bg-black/20 text-center transition-colors duration-700">
           <p className="text-[9px] text-black/20 dark:text-white/10 uppercase tracking-[0.2em] font-light italic">
             vibra el momento
           </p>
        </div>
      </div>
